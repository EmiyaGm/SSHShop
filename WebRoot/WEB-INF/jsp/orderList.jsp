		...
		<div class="span24">
			...
			<div class="step step1">
				...
				<table>
					...
					<tr>
						<th colspan="5">订单编号：<s:property value="modle.oid" />&nbsp;&nbsp;&nbsp;&nbsp;
						订单状态
						<s:if test="#order.state==1">
							<a href="${pageContext.request.contextPath}/order_findByOid.action?oid=<s:property value="modle.oid" />"><font color="red">付款</font></a>
						</s:if>
					...
					<s:iterator var="orderItem" value="#order.orderItems">
						...
						<tr>
							...
							<td>
								<s:property value="#orderItem.shop_price" />
							</td>
